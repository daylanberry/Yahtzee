...
const sixes = new TotalOneNumber({ val: 6, description: 'sum all sixes' });
...
const fullHouse = new FullHouse({ score: 25, description: 'scores a flat 25' });
...
const yahtzee = new Yahtzee({ score: 50, description: 'all of the same card' });
